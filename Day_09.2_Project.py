...
list_of_cities = eval(input("Enter list of cities: ")) # create list from formatted string
...
def add_new_country(c_name, no_of_visits, cities_visited):
    temp_dict = {}
    temp_dict["country"] = c_name
    temp_dict["visits"] = no_of_visits
    temp_dict["cities"] = cities_visited
